...
# Views for loading data from json file to the template
class ShowJSONInTemplate(View):
    template_name = "onion_leafs/show_table_from_json.html"
    ...
    def generateGraph(graphData, title):
        ...
        # Export as HTML
        fig.write_html("onion/templates/onion_leafs/plot_json.html")


    def get(self, request, *args, **kwargs):
        with open("onion/data/stock_market_data.json", "r") as json_file:
